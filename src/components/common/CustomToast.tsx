...
const CustomToast: React.FC<CustomToastProps> = ({
  ...
  const icon: ImageSourcePropType =
    type === "success"
      ? require("./../../../assets/myImages/check.png") // Replace with your success icon
      : type === "error"
      ? require("./../../../assets/myImages/cancel.png") // Replace with your error icon
      : require("./../../../assets/myImages/about.png"); // Replace with your info icon
  ...
  const hideToast = () => {
    Animated.spring(translateY, {
      toValue: 150, // Move the toast back below the screen
      friction: 5,
      tension: 100,
...
const styles = StyleSheet.create({
  toastContainer: {
    position: "absolute",
    bottom: 50, // Start from the bottom
    left: "10%",
    right: "10%",
